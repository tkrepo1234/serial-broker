 ...
 * vendor ID, a product ID or a device type (ADR-0015). The library takes the device from the port
 * chosen in the picker and remembers it (ADR-0022), so nothing about the port is derived here:
 ...
 * configuration at once and a plain release keeps what is remembered (ADR-0020): without it the

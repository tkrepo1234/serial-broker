 ...
 * has to do is recognise which of them is the configured device. See ADR-0022.
 *
 ...
 * serial profile (ADR-0022). A non-USB filter matches exactly those. An auto-mode filter matches
 * what it has resolved to, and nothing before it has: the user's choice is the resolution, and a
 * port granted for something else is not it (ADR-0022).
 */
...
/**
 * The device a chosen port is, as auto mode resolves it (ADR-0022).
 *

...
export default defineConfig({
  // This file lives in config/ (ADR-0025), but every path below names the repository, not the
  ...
  test: {
    ...
    // uses is injected (ADR-0012), so code that reaches for a global fails loudly in tests

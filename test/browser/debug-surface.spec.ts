 ...
 *
 * The page is shipped in the package (ADR-0015) and is what someone reaches for when a device
 ...
 * for it as well, so dropping a remembered entry does not mean connecting to it first. See ADR-0020
 * for what releasing does and does not forget, and ADR-0021 for why this suite looks the way it
 * does.
 */

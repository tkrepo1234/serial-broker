...
- **Run:** 2026-09-17 19:21:07 UTC, every bound held
...
| largest payloads back to back | broadcastchannel | tabs 4, payloads 12, payloadMiB 16, queuedAtOnce 4 | 1.7 s | 60 (60) | 180 (240) |
| a long-lived owner accepting writes | sharedworker | tabs 10, writes 50,000, burst 50 | 3.9 s | 230,000 (250,000) | 990,000 (2,500,000) |
| a long-lived owner accepting writes | broadcastchannel | tabs 10, writes 50,000, burst 50 | 5.7 s | 230,000 (250,000) | 2,070,000 (2,500,000) |
...
| sustained device traffic | broadcastchannel | tabs 10, simulatedMinutes 60, baud 115,200, chunks 162,000, megabytes 41.3 | 6.3 s | 162,000 (162,010) | 1,458,000 (1,458,100) |
| writes under owner crashes | sharedworker | writes 10,000, writers 20, writesPerCrash 100 | 3.0 s | 64,800 (80,000) | 730,500 (1,600,000) |
| writes under owner crashes | broadcastchannel | writes 10,000, writers 20, writesPerCrash 100 | 5.0 s | 74,400 (80,000) | 1,414,000 (1,600,000) |
...
| tabs freezing under load | broadcastchannel | 15.14 → 15.32 | 0.13 | 0 | 0 | 20 | 30 | 13 | 18 | 0 | 0 | 0 |
...
| a long-lived owner accepting writes | sharedworker | 15.42 → 14.38 | 0.13 | 0 | 0 | 20 | 30 | 23 | 38 | 0 | 0 | 10 |
| a long-lived owner accepting writes | broadcastchannel | 14.36 → 14.35 | 0.13 | 0 | 0 | 20 | 30 | 13 | 18 | 0 | 0 | 0 |
...
| 20 configurations x 10 tabs | sharedworker | 19.67 → 19.84 | 0.13 | 0 | 0 | 20 | 600 | 251 | 380 | 0 | 0 | 10 |
| 100 tabs, one configuration | broadcastchannel | 18.76 → 18.79 | 0.13 | 0 | 0 | 200 | 300 | 103 | 198 | 0 | 0 | 0 |
| 100 tabs, the holder closed 10 times | broadcastchannel | 18.82 → 20.1 | 0.13 | 0 | 0 | 200 | 0 | 103 | 198 | 0 | 0 | 0 |
| 20 configurations x 10 tabs | broadcastchannel | 19.97 → 19.99 | 0.13 | 0 | 0 | 20 | 600 | 241 | 360 | 0 | 0 | 0 |
| diagnostics observer under load | sharedworker | 15.03 → 15.69 | 0.13 | 0 | 0 | 20 | 0 | 24 | 40 | 0 | 0 | 11 |
| diagnostics observer under load | broadcastchannel | 15.55 → 15.69 | 0.13 | 0 | 0 | 20 | 0 | 13 | 18 | 0 | 0 | 0 |
| setup and release churn | sharedworker | 14.77 → 16.13 | 0.13 | 0 | 0 | 4 | 0 | 3 | 4 | 0 | 0 | 2 |
...
| a simulated week | broadcastchannel | 15.11 → 15.23 | 0.13 | 0 | 0 | 20 | 30 | 13 | 18 | 0 | 0 | 0 |
| sustained device traffic | sharedworker | 14.77 → 15.24 | 0.14 | 0 | 0 | 20 | 20 | 23 | 38 | 0 | 0 | 10 |
| sustained device traffic | broadcastchannel | 15.11 → 15.26 | 0.14 | 0 | 0 | 20 | 20 | 13 | 18 | 0 | 0 | 0 |
| writes under owner crashes | sharedworker | 15.13 → 16.42 | 0.15 | 0 | 0 | 40 | 0 | 43 | 78 | 0 | 0 | 20 |

...
- **Refuse to run when a different version is detected.** Stops the *new* tab from working
  because an *old* tab exists — punishing the up-to-date context. Rejected in favour of

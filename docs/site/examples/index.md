...
| ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [examples/terminal](https://github.com/tkrepo1234/serial-broker/tree/main/examples/terminal)                       | **The terminal, and the one to read first**: connection settings, text and hex, ANSI colours, timestamps, saved logs, a dark theme and an experimental file transfer. Static HTML, no build step, and no web server: the folder runs opened from a file. |
| [examples/terminal-openui5](https://github.com/tkrepo1234/serial-broker/tree/main/examples/terminal-openui5)       | The same terminal as a SAP OpenUI5 application in `sap_horizon` and `sap_horizon_dark`. Its build runs from a folder opened as a file, with no server and no internet.                                                                                   |
